...
% OUTPUTS: 
    % 4 x 4 figure containing the results of clustering on each of the most
    % informative combinations of wavelengths 
...
for i = 1:subplotnum
    ...
    text(min(histg.BinEdges),max(histg.Values)*.3,['to other top combinations '],'Color','r')
